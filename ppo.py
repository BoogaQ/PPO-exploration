...
class BaseAlgorithm(ABC):
    def __init__(self, env, 
        ...
        self.action_dim = env.action_space.n if env.action_space.__class__.__name__ == "Discrete" else env.action_space.shape[0]
...
class PPO(BaseAlgorithm):
    def __init__(self, *, 
        ...
        self.policy = Policy(env = env)
        self.rollout = RolloutStorage(nstep, self.num_envs, env.observation_space, self.action_dim, gae_lam = gae_lam)
